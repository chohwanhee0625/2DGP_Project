...
class Run:
    ...
    @staticmethod
    def do(car):
        car.x += car.dir * CAR_SPEED_PPS * game_framework.frame_time
        if car.y >= 0:
            car.y += CAR_SPEED_PPS*game_framework.frame_time - 0.5 * GRAVITY * game_framework.frame_time * game_framework.frame_time
